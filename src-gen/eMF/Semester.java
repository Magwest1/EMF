 ...
 *   <li>{@link eMF.Semester#getSpecializtaion <em>Specializtaion</em>}</li>
 * </ul>
 *
...
public interface Semester extends EObject {
	...
	/**
	 * Returns the value of the '<em><b>Specializtaion</b></em>' reference.
	 * It is bidirectional and its opposite is '{@link eMF.Specialization#getSpecializationInSemester <em>Specialization In Semester</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Specializtaion</em>' reference.
	 * @see #setSpecializtaion(Specialization)
	 * @see eMF.EMFPackage#getSemester_Specializtaion()
	 * @see eMF.Specialization#getSpecializationInSemester
	 * @model opposite="specializationInSemester"
	 * @generated
	 */
	Specialization getSpecializtaion();

	/**
	 * Sets the value of the '{@link eMF.Semester#getSpecializtaion <em>Specializtaion</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Specializtaion</em>' reference.
	 * @see #getSpecializtaion()
	 * @generated
	 */
	void setSpecializtaion(Specialization value);
