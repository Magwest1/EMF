...
public interface courseInSemester extends EObject {
	...
	/**
	 * Returns the value of the '<em><b>Course In</b></em>' reference.
	 * It is bidirectional and its opposite is '{@link eMF.Semester#getCourses <em>Courses</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Course In</em>' reference.
	...
	/**
	 * Sets the value of the '{@link eMF.courseInSemester#getCourseIn <em>Course In</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Course In</em>' reference.
	 * @see #getCourseIn()
	 * @generated
	 */
