 ...
 *   <li>{@link eMF.Course#getMandatoryInSpecialization <em>Mandatory In Specialization</em>}</li>
 *   <li>{@link eMF.Course#getCourse <em>Course</em>}</li>
 *   <li>{@link eMF.Course#getMandatoryInProgramme <em>Mandatory In Programme</em>}</li>
 * </ul>
 *
...
public interface Course extends EObject {
	 ...
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Mandatory In Specialization</em>' reference.
	 * @see #setMandatoryInSpecialization(Specialization)
	 * @see eMF.EMFPackage#getCourse_MandatoryInSpecialization()
	 * @model
	 * @generated
	 */
	Specialization getMandatoryInSpecialization();

	/**
	 * Sets the value of the '{@link eMF.Course#getMandatoryInSpecialization <em>Mandatory In Specialization</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Mandatory In Specialization</em>' reference.
	 * @see #getMandatoryInSpecialization()
	 * @generated
	 */
	void setMandatoryInSpecialization(Specialization value);
	...
	/**
	 * Returns the value of the '<em><b>Mandatory In Programme</b></em>' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Mandatory In Programme</em>' reference.
	 * @see #setMandatoryInProgramme(Programme)
	 * @see eMF.EMFPackage#getCourse_MandatoryInProgramme()
	 * @model
	 * @generated
	 */
	Programme getMandatoryInProgramme();

	/**
	 * Sets the value of the '{@link eMF.Course#getMandatoryInProgramme <em>Mandatory In Programme</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Mandatory In Programme</em>' reference.
	 * @see #getMandatoryInProgramme()
	 * @generated
	 */
	void setMandatoryInProgramme(Programme value);
